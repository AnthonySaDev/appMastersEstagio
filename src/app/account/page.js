          ...
          <div>
            ...
            <div className="relative my-5">
              <input
                ...
                type="text"
                id="name"
                className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-white bg-transparent rounded-lg border border-orange-600 appearance-non dark:border-zinc-500 dark:focus:border-orange-600 focus:outline-none focus:ring-0 focus:border-orange-600 peer" placeholder=" " />

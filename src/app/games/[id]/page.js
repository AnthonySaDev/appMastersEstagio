...
export default function Games({ params }) {
  ...
  const addFavorite = () => {
    if (!user) {
      toast.warn("You need to be authenticated to favorite a game, access account.");
      return;
    }
  ...
  return (
    <div className="font-sans">
      <div className="flex bg-black h-fit md:h-screen md:max-w-10/12 mx-auto pb-10 mb:pb-0 bg-opacity-75 flex-col md:flex-col-reverse items-center justify-center">
        <Header />
